...
module.exports = "<header class=\"header-login-signup\">\n\n\t<div class=\"header-limiter\">\n\n\t\t<h1><a routerLink=\"home\"><span>Albergo</span></a></h1>\n\n\t\t<nav>\n\t\t\t<a routerLink=\"home\">Home</a>\n\t\t\t<a routerLink=\"test\" class=\"selected\">Blog</a>\n\t\t\t<a routerLink=\"home\">Pricing</a>\n\t\t</nav>\n\n\t\t<ul>\n\t\t\t<li><a routerLink=\"login\">Login</a></li>\n\t\t\t<li><a routerLink=\"registration\">registration</a></li>\n\t\t</ul>\n\n\t</div>\n\n</header>\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent() {
        console.log("mannaggia ai santi");
    }
...
module.exports = __webpack_require__(/*! /var/www/hotel/src/main.ts */"./src/main.ts");
