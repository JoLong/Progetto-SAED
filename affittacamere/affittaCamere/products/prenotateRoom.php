...
// get from date
$occupedFrom=isset($_GET["occuped_from"]) ? $_GET["occuped_from"] : "";
$occupedFrom = setDate($occupedFrom);

// get to date
$occupedTo=isset($_GET["occuped_to"]) ? $_GET["occuped_to"] : "";
$occupedTo = setDate($occupedTo);
...
$room->occuped_from = $occupedFrom;
$room->occuped_to = $occupedTo;
